...
VALUES 
('Cửa hàng điện tử A', 'assets/img/shop/shop_a_logo.png', '123 Đường Công Nghệ, Thành phố', 'Nguyễn Văn A'),
('Thời trang ABC', 'assets/img/shop/shop_b_logo.png', '456 Đại lộ Thời Trang, Thành phố', 'Trần Thị B'),
('Siêu thị mini 24h', 'assets/img/shop/shop_c_logo.png', '789 Phố Mua Sắm, Thành phố', 'Lê Văn C'),
('Cửa hàng mỹ phẩm X', 'assets/img/shop/shop_d_logo.png', '101 Phố Làm Đẹp, Thành phố', 'Phạm Thị D'),
('Shop giày thể thao', 'assets/img/shop/shop_e_logo.png', '112 Khu Giày Dép, Thành phố', 'Đặng Văn E');
