...
<html>
    <head>
        ...
        <style>
            /* CSS để căn lề trái cho cột "Sản phẩm" */
            .product-column {
                text-align: left !important;
                padding-left: 0; /* Loại bỏ padding mặc định bên trái nếu cần */
            }

            /* CSS để căn chỉnh nội dung bên trong cột "Sản phẩm" */
            .product-column .d-flex {
                justify-content: flex-start !important; /* Căn lề trái cho hình ảnh và tên sản phẩm */
            }

            /* Đổi màu chữ của nút "Xóa" thành màu trắng */
            .btn-danger {
                color: white !important;
            }

            /* Đảm bảo nút không bị ảnh hưởng bởi hover mặc định */
            .btn-danger:hover {
                color: white !important;
            }
        </style>
