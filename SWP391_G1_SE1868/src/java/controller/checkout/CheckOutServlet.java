...
public class CheckOutServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (customer == null) {
            ...
            List<Cart> carts = customerDAO.getCartsByCustomerId(1);

            // truyền carts sang jsp
            request.setAttribute("carts", carts);

            // truyền tổng giá tiền
            request.setAttribute("totalCart", customerDAO.getTotalAmount(1));

            request.setAttribute("customer", customerDAO.getCustomerByIdNoJoin(1));
